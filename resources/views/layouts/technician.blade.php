        ...
        <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
            ...
            <div class="relative flex items-center gap-3 px-6 h-16 border-b border-white/10">
                ...
                <div>
                    ...
                    <p class="text-[10px] uppercase tracking-widest text-jewel-gold/70">Workshop Panel</p>
                </div>
            </div>

            <nav class="relative flex-1 px-3 py-6 space-y-1">
                <a href="{{ route('technician.dashboard') }}"
                    class="jewel-sidebar-link {{ request()->routeIs('technician.dashboard', 'technician.jobs.*') ? 'jewel-sidebar-link-active' : 'jewel-sidebar-link-inactive' }}">
